...
export default function A2UIVisualizer({ entry }: A2UIVisualizerProps) {
  ...
  switch (nodeType) {
    case 'provider':
      return (
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-3 space-y-2 relative overflow-hidden">
          ...
          <div className="text-xs text-gray-300">
            Endpoint: <code className="text-gray-200 font-mono">{(entry.request as any)?.endpoint || 'sandbox'}</code>
          </div>
          <div className="text-xs text-gray-300">
            Model: <code className="text-gray-200 font-mono">{(entry.request as any)?.model || 'mock-gpt-4o'}</code>
          </div>
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-3 space-y-2 relative overflow-hidden">
          <div className="flex items-center justify-between text-xs text-gray-300 font-semibold uppercase tracking-wider">
            <span className="flex items-center gap-1">
              <Sparkles size={13} className="text-gray-400 animate-spin-slow" />
              LLM Prompt Execution
            </span>
          </div>

          <div className="border border-gray-800 bg-gray-950/60 rounded p-2 text-xs space-y-1.5">
            <div className="text-[10px] text-gray-400 uppercase tracking-widest font-mono">System Instructions</div>
            ...
            <div className="text-[10px] text-gray-400 uppercase tracking-widest font-mono">User Query</div>
          ...
          <div className="flex justify-center py-1">
            <div className="flex items-center gap-1 bg-gray-950 px-2 py-0.5 rounded text-[10px] text-gray-200 border border-gray-800 animate-pulse">
          ...
          <div className="bg-gray-900 border border-gray-700 rounded p-2 text-xs text-gray-100 font-mono">
            <div className="text-[10px] text-gray-400 uppercase tracking-widest font-semibold mb-1">Generated Output</div>
    ...
    case 'search':
      return (
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-3 space-y-2 relative overflow-hidden">
          ...
          <div className="text-xs text-gray-300">
            Query: <code className="text-gray-200 font-mono">"{(entry.request as any)?.query || 'mock search'}"</code>
          </div>

          <div className="flex items-center justify-center py-1">
            <div className="w-full bg-gray-950 border border-gray-800 rounded px-2 py-1 text-[11px] text-gray-200 space-y-1">
              <div className="flex items-center justify-between text-[9px] text-gray-400 font-semibold tracking-wider uppercase">
    ...
    case 'mcp':
      return (
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-3 space-y-2 relative overflow-hidden">
          ...
          <div className="text-xs text-gray-300">
            Tool Name: <code className="text-gray-200 font-mono bg-gray-950 px-1 rounded">{(entry.request as any)?.tool || 'mock_tool'}</code>
          </div>

          <div className="text-xs text-gray-300">
            Arguments: 
            <pre className="text-gray-200 font-mono text-[10px] mt-1 bg-gray-950/60 rounded p-1.5 truncate">
              {JSON.stringify((entry.request as any)?.arguments || {}, null, 2)}
            </pre>
          </div>

          <div className="bg-gray-950/50 border border-gray-700 rounded p-2 text-xs text-gray-100 font-mono">
            <div className="text-[10px] text-gray-400 uppercase tracking-widest font-semibold mb-1">Execution Output</div>
    ...
    case 'browser':
      return (
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-3 space-y-2 relative overflow-hidden">
          ...
          <div className="text-xs text-gray-300">
            Navigated: <code className="text-gray-200 font-mono">{(entry.request as any)?.url || 'https://sandbox.site'}</code>
          </div>

          <div className="bg-gray-950/60 rounded p-2 text-xs text-gray-400 space-y-1">
            <div className="text-[9px] text-gray-400 font-semibold tracking-wider uppercase">Scraped Text Extract</div>
    ...
    case 'registry':
      return (
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-3 space-y-2 relative overflow-hidden">
          ...
          <div className="text-xs text-gray-300">
            Action: <code className="text-gray-200 font-mono bg-gray-950 px-1 rounded">Register/Call Custom Node Code</code>
          </div>

          <div className="bg-gray-950/60 rounded p-2 text-xs text-gray-400 space-y-1">
            <div className="text-[9px] text-gray-400 font-semibold tracking-wider uppercase">Registry Status</div>
            <div className="truncate italic">
